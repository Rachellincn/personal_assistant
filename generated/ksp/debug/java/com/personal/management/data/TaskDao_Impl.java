...
public final class TaskDao_Impl implements TaskDao {
  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `tasks` (`id`,`description`,`time`,`priority`,`isCompleted`,`date`,`summary`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfTask = new EntityDeletionOrUpdateAdapter<Task>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `tasks` SET `id` = ?,`description` = ?,`time` = ?,`priority` = ?,`isCompleted` = ?,`date` = ?,`summary` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfMarkTaskComplete = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE tasks SET isCompleted = ?, summary = ? WHERE id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object markTaskComplete(final int id, final boolean isCompleted, final String summary,
  ...
  @Override
  public LiveData<List<Task>> getTasksByDate(final long startTime, final long endTime) {
    final String _sql = "SELECT * FROM tasks WHERE date >= ? AND date <= ? ORDER BY time ASC";
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Task(_tmpId,_tmpDescription,_tmpTime,_tmpPriority,_tmpIsCompleted,_tmpDate,_tmpSummary);
            _result.add(_item);
          }
          return _result;
        } finally {
